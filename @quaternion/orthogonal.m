...
% TODO It should be possible to make this work for arrays V and W (of the
% same size obviously). The original intent of this function was to supply
% unit vectors for use in QFT calculations, but it has other uses where the
% ability to pass array arguments could be useful. The only tricky part to
% vectorise is the choice of W if not given. The present code is written
...
% $Id: orthogonal.m,v 1.20 2016/06/15 13:19:43 sangwine Exp $
