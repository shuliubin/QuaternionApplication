...
if nargin == 1
    ...
    elseif ismatrix(A) % The algorithm is as above for vectors, but instead
                       % of a single element P, we now have a vector, with
                       % one element per column of A.
...
% $Id: cumprod.m,v 1.9 2016/06/15 13:19:43 sangwine Exp $
