...
% TODO Implement a shape option 'wrap' which gives wrap-around convolution.
% (Modulo indexing.) This is for compatibility with the FFT2 function.
...
if iscell(w)
    ...
    if numel(w) < numel(x) % Is this the best comparison that
...
% $Id: conv2.m,v 1.15 2016/06/15 13:19:43 sangwine Exp $
