...
check(1i.^2 == -1, 'i^2 is not -1, perhaps been redefined?');
...
check(abs(quaternion(1,1,1,1)+quaternion(1,1,1,1).*1i) == 2 + 2.*1i,...
...
% $Id: test_fundamentals.m,v 1.10 2016/06/15 09:00:01 sangwine Exp $
