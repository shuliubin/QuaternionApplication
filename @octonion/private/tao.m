function P = tao(A)
% TAO Computes the tao adjoint of the quaternion matrix A as in:
%
...
% defines TAO for a single quaternion, but here we extend the idea to a
...
% $Id: tao.m,v 1.2 2016/06/15 13:19:45 sangwine Exp $
